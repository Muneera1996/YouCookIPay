...
public class NewOrdersActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isConnected()){
            ...
            final String url="http://www.businessmarkaz.com/test/ucookipayws/user/new_orders?user_id="+LoginInActivity.users.get(0).getUser_id()+"&session_id="+LoginInActivity.users.get(0).getSession_id();
